...
<article class="content static-tables-page">
    ...
    @include('errors.note')
    <div class="title-block">
        <h3 class="title"> Thêm dịch vụ con </h3>
    </div>
    @if(isset($errors))
    ...
    <form  method="post" enctype="multipart/form-data">
        ...
        <fieldset class="form-group">
            ...
            <input type="text" class="form-control" name="type_name"> </fieldset>
        <fieldset class="form-group">
            <label class="control-label" for="type_price">Giá bán</label>
            <input type="num" class="form-control" name="type_price"> </fieldset>
        <fieldset class="form-group">
            <label class="control-label" for="unit">Đơn vị tính</label>
            <input type="text" class="form-control" name="unit" placeholder="ex: head, piece, gram, box, ..."> </fieldset>
