...
@section('title', 'EM Hair Salon - Dashboard')
...
@section('content')
    ...
    <article class="content dashboard-page">
	    ...
	    <div class="title-block">
	        <h1 class="title"> Trang quản trị website EM Hair Salon </h1>
                ...
                <div class="col-xl-12">
                    <div class="card sameheight-item items" data-exclude="xs,sm,lg">
                        <div class="card-header bordered">
                            <div class="header-block">
                                <h3 class="title"> Lịch hẹn </h3>
                                <a href="item-editor.html" class="btn btn-primary btn-sm"> Thêm mới </a>
                            </div>
