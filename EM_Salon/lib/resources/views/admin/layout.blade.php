                        ...
                        <ul class="nav-profile">
                            ...
                            <li class="profile dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                    <div class="img" style="background-image: url('{{asset('lib/storage/app/avatar/'.Auth::user()->avatar)}}')"> </div>
                        ...
                        <div class="sidebar-header">
                            <div class="brand">
                                <a href="/EM_Salon" target="_blank">
                                    ...
                                    </div> EM Hair Salon </div>
                                </a>
                        </div>
                        <nav class="menu">
                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                <li class="active">
                                    <a href="/EM_Salon/admin/home">
                                        <i class="fa fa-home"></i> Dashboard </a>
                                </li>
                                <!-- Start Appointment -->
                                <li>
                                    <a href="{{asset('admin/appointment')}}">
                                        <i class="fa fa-th-large"></i> Appointment
                                        <i class="fa arrow"></i>
                                    </a>
                                </li>
                                <!-- End Appointment -->
                                ...
                                <!-- Start Service Types -->
                                <li>
                                    <a href="{{asset('admin/service-type')}}">
                                        <i class="fa fa-th-large"></i> Service Types
                                        <i class="fa arrow"></i>
                                    </a>
                                </li>
                                <!-- End Service Types-->
                                <!-- Start Manage Service Categories -->
                                <li>
                                    <a href="{{asset('admin/service-category')}}">
                                        <i class="fa fa-th-large"></i> Service Categories
                                        <i class="fa arrow"></i>
                                    </a>
                                </li>
                                <!-- End Manage Service Categories -->
                                <!-- Start Users -->
                                <li>
                                    <a href="{{asset('admin/user')}}">
                                        <i class="fa fa-th-large"></i> Users
                                        <i class="fa arrow"></i>
                                    </a>
                                </li>
                                <!-- End Users -->
                                ...
                                <li>
                                    <a href="{{asset('admin/brand')}}">
                                        <i class="fa fa-th-large"></i> Brands
                                        <i class="fa arrow"></i>
                                    </a>
                                </li>
                                <!-- End Brands --> 
                                ...
                                <li>
                                    <a href="news-categories">
                                        <i class="fa fa-th-large"></i> News Categories
                                    </a>
                                </li>
