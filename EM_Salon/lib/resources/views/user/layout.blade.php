...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/lightbox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('public/admin_asset/css/owl.carousel.min.css') }}">
				...
				<div class="container">
                    ...
                    <div class="collapse navbar-collapse  text-center" id="navNavbar">
                        <ul class="navbar-nav ml-auto ">
                            ...
                            <li class="nav-item">
                                <a href="{{asset('/service')}}" class="nav-link" >Services</a>
                            </li>
                            <li class="nav-item">
...
<!-- FOOTER END -->
    ...
    <script src="{{ asset('public/admin_asset/js/popper.min.js') }}"></script>
    <script src="{{ asset('public/admin_asset/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('public/admin_asset/js/all.min.js') }}"></script>
    <script src="{{ asset('public/admin_asset/js/lightbox-plus-jquery.min.js') }}"></script>
    
    

    <script src="{{ asset('public/admin_asset/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('public/admin_asset/js/appp.js') }}"></script>
    <script src="{{ asset('public/admin_asset/js/style.js') }}"></script>    
    @yield('script')
    </body>
